...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 4:
            ...
            Type.info="<div id = 'critical'>我</div>が道を行くマイペースで、些細なはとらわれない寛容な心を持っています。集団よりも一人行動が好きで、猫のようにふらっとどこかに出かけるのが好きです。基本的にインドアで冬はこたつから離れらません。もこもこした服、ゆるっとした服がよく似合うでしょう。寒い冬に出かけないといけない時は、充電できるカイロを持って外出中もぬくぬくしましょう♨";   // 基本情報
