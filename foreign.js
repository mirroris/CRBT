...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 6:
            ...
            Type.beansSub="待機電力とは電子機器を使っていなくてもコンセントに繋いでいるだけで消費される電力のことです。待機電力の消費電力量は一世帯あたり年間で228kWと推定され、電気代に換算すると年間約6,156円も無駄にしています。<br>待機電力を無くすには電子機器をコンセントから抜く必要がありますが、毎回外すのは面倒ですよね。そこで役に立つのが節電タップ!節電タップは各コンセントの挿し口にON･OFFのスイッチが付いており、使わないときはスイッチを押すだけなので簡単に待機電力分を節約することが出来ます。<br>節電タップを使用するだけで、待機電力を約50%も削減できます。節約･節電の為に、通常のたこ足配線はやめて節電タップにしませんか？<br>";
            break;
