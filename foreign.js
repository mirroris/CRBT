...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 3:
            ...
            Type.info="<div id = 'critical'>ポ</div>ジティブで、周りの人を明るく太陽のような存在です<br>流行のものが好きで、趣味なども常に最先端！<br>セットアップなど韓国風ファッションが似合うかも<br>レインボーに光るストローを持ってカフェに行けばインスタ映え間違いなし！<br>自ら流行を生み出してみませんか？？";   // 基本情報
        ...
        case 5:
            ...
            Type.info="<div id = 'critical'>真</div>面目さと正直さがとりえです。<br>誘われたり頼まれたりすると断れないタイプ。<br>面倒見が良いため、こども・年下にはよく好かれることでしょう。<br>スーツなどのフォーマルなファッションが良く似合います。<br>就活や塾バイトのためにスーツで大学に来ることも。<br>ごはん時にお弁当とマイ箸を取り出せば、好感度は上がるに違いありません。<br>もちろん正しく箸は持ちましょう！<br>"; 
            Type.item="マイ箸";  // アイテム
