...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 6:
            ...
            Type.info="<div id = 'critical'>効</div>率的、論理的な知性派です。感情よりも論理性を重視しますが、決断する時は直感的になりがち。ユニクロなどシンプルな服装を着がちですが、柄シャツを選ぶと一気にオシャレの幅が広がるでしょう。パソコンなどの電子機器を使う場面が多いので、複数の機器を充電できて且つ節電にもなる、節電タップがオススメです。お洒落で格好良い理系大学生を目指しませんか？";   // 基本情報
        ...
        case 7:
            ...
            Type.info="<div id = 'critical'>い</div>つもみんなの盛り上げ役でムードメーカ<br>誰に対しても優しく裏表がない性格なので、周りの人からは厚く信頼されています。体を動かすのが好きで、体育や部活・サークルの時はジャージで登校することも。暑い日に運動した後は、手で持てる扇風機や首から掛ける扇風機で快適に過ごしてみてはいかがでしょうか。";  // 基本情報
            Type.item="扇風機";  // アイテム
            Type.img="result7.png";   // キャラ画像
            Type.beans="効果的な扇風機の使い方"; //豆知識
            Type.beansSub="扇風機の賢い使い方を2つ紹介します。<br><br>①暑い夏はタイマー付きの扇風機で快適に。<br>就寝時間の1/3ずつON･OFFを変えるタイマーをセットします。扇風機を入眠後数時間と起床前数時間だけでも稼働させることで、快適な睡眠に繋がるとともに節電にもなります。<br><br>②部屋の温度を効率的に下げるには。<br>扇風機を窓に向けて置きましょう。部屋の奥の熱い空気を外に素早く出すことが出来るため、効率的に室温を下げることが出来ます<br><br>③就寝中に使用する際<br>壁に向けて扇風機を設置すると、寝ている間に身体が冷えることを防げます。壁に当てることで空気が柔らかくなり心地空気を作り出すことが出来ます。";
            break;
        case 8:
    ...
    let info = '<br><div class = "supervisor"><div class = "iteminfo" id = "iteminfo">'+Type.info+"<br></div></div>";
   
    let beans =  '<div class = "beans"> <div id="top"><br>【'+Type.beans+'】<br></div><div class = "supervisor"><div class="beansSub">'+Type.beansSub+'<br></div></div>';
