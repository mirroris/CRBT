...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 7:
            ...
            Type.info="<div id = 'critical'>い</div>つもみんなの盛り上げ役でムードメーカー<br>誰に対しても優しく裏表がない性格なので、周りの人からは厚く信頼されています。体を動かすのが好きで、体育や部活・サークルの時はジャージで登校することも。暑い日に運動した後は、手で持てる扇風機や首から掛ける扇風機で快適に過ごしてみてはいかがでしょうか。";  // 基本情報
            Type.item="扇風機";  // アイテム
