...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 6:
            ...
            Type.info="<div id = 'critical'>効</div>率的、論理的な知性派です。感情よりも論理性を重視しますが、決断する時は直感的になりがち。ユニクロなどシンプルな服装を着がちですが、柄シャツを選ぶと一気にオシャレの幅が広がります。";   // 基本情報
            Type.item="節電タップ";  // アイテム
            Type.img="result6.png";   // キャラ画像
            Type.beans="待機電力のはなし"; //豆知識分
            Type.beansSub="待機電力とは電子機器を使っていなくてもコンセントに繋いでいるだけで消費される電力のことです。待機電力の消費電力量は一世帯あたり年間で228kWと推定され、電気代に換算すると年間約6,156円も無駄にしています。待機電力を無くすには電子機器をコンセントから抜く必要がありますが、毎回外すのは面倒ではありませんか？そこで";
            break;
