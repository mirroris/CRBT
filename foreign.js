...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 8:
            ...
            Type.beansSub="ソーラー式充電器は基本的に普通の充電器よりも大きくて重いのがデメリットで、アウトドアには向いていないことが多いです。そこで今回は日常生活やアウトドアでも使える、世界一薄いと言われるsolar paperという製品をご紹介します!ソーラーペーパーは折りたたんだ際に9cm×19cm×1.1cm(厚)になり、重さも各パネル約70gと軽い方です。太陽光下では約2.5時間でスマホを充電することが出来ます。またスマホだけでなくUSBで充電できる全てのデバイスで充電が可能です。懐中電灯や蓄電池、トランシーバーなどアウトドアで必要な道具も全て充電できます。そして、このソーラーペーパーの太陽電子効率は1パネルあたり約23%で、同様の製品と比べても発電効率が良いとされています。<br>今後、さらに薄くて軽いソーラーモバイルバッテリーが開発されていくことでしょう。紙みたいに薄い製品が生まれるかもしれません。今後が楽しみです。";
            break;
    }
