...
function accumulate(){
    ...
    switch(chtype+1){
        ...
        case 7:
            ...
            Type.beansSub="扇風機の賢い使い方を4つ紹介します。<br><br>①暑い夏はタイマー付きの扇風機で快適に。<br>就寝時間の1/3ずつON･OFFを変えるタイマーをセットします。扇風機を入眠後数時間と起床前数時間だけでも稼働させることで、快適な睡眠に繋がるとともに節電にもなります。<br><br>②部屋の温度を効率的に下げるには、<br><br>扇風機を窓に向けて置きましょう。部屋の奥の熱い空気を外に素早く出すことが出来るため、効率的に室温を下げることが出来ます<br><br>";
            break;
        case 8:
